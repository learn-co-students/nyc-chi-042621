...
$adding_a_new_model = [
    {
        name: "Draw the domain model out to see all the relationships. Identify the joiner.",
        code: ""
    },
    {
        name: "Write the migrations: create a new table and if need be, add columns (e.g. foreign keys) to the other ones, and then run the migration and check the schema to see if it's correct",
        code: "follow 'adding table' rake task"
    },
    {
        name: "Add the new file for the model in the 'app/models' with the singular name and write the class code there",
        code: ""
    },
    {
        name: "Set up associations",
        code: "On the one side of the relationship set up: 'has_many :somethings' (plural) and 'has_many :something_elses, through: :somethings'. On the other side of the relationship: 'belongs_to :something' (singular)"
    },
    {
        name: "Add the newly-created classes to the seeds file",
        code: "Something.destroy_all",
    },
    {
        name: "Create instances of the new model in the seeds and then test it in the rake console by trying to reach associated instances",
        code: "",
    }
]
